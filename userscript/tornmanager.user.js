...
`;
  ...
  const STORAGE_KEY$1 = "tm_targets";
  class Targets {
    getAll() {
      try {
  ...
  class Overlay {
    ...
    devTabsEnabled() {
      var _a;
      return ((_a = this.auth.getUser()) == null ? void 0 : _a.torn_id) === DEV_TORN_ID;
    }
    createTabBar() {
