...
Stack: ${e.stack}` : ""}`
  ...
  const TM_LOGO$1 = '<svg viewBox="0 0 32 32" width="16" height="16"><rect width="32" height="32" rx="7" fill="#0070f3"/><text x="16" y="22" text-anchor="middle" font-family="Arial,sans-serif" font-weight="700" font-size="15" fill="#fff">TM</text></svg>';
  class SettingsMenuEntry {
    ...
    inject(menu) {
      ...
      link.href = "#";
      link.innerHTML = `${TM_LOGO$1}<span>TornManager</span>`;
