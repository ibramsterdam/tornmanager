...
`;
  ...
  class MugHelper {
    ...
    createPlaceholder() {
      ...
      wrap.innerHTML = HELPER_ICON + '<p class="tm-mh-placeholder-title">Mug helper</p><p class="tm-mh-placeholder-text">Live mugging tools will live here. Drag the header to move it, drag the corner to resize.</p>';
      return wrap;
    }
    applyPosition() {
