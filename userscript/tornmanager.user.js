  ...
  class ChatBox {
    ...
    showHouseRules() {
      ...
      const rules = [
        ...
        this.room.anonymous ? "This room is anonymous for other players. For moderation it is not encrypted, so I can link messages to accounts." : "This room shows your Torn name. It is not encrypted, so I can read messages for moderation.",
