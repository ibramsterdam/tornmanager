...
`;
  ...
  class MuggingSection {
    constructor(api2, mugHelper2) {
      this.api = api2;
      this.mugHelper = mugHelper2;
    }
    render() {
      this.section = document.createElement("div");
  ...
  class Overlay {
    constructor(auth2, api2, logger2, chatDock2, mugHelper2) {
      this.auth = auth2;
      this.api = api2;
      this.logger = logger2;
      this.chatDock = chatDock2;
  ...
  const DISMISS_TTL_MS = 12 * 60 * 60 * 1e3;
  ...
  const MugTargets = {
    ...
    async scan(ids, { force = false, onProgress, onTarget } = {}) {
      ...
      for (const id of limited) {
        ...
        if (((_a = cache[id]) == null ? void 0 : _a.muggable) && !dismissed[id]) onTarget == null ? void 0 : onTarget(cache[id]);
