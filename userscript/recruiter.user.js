...
// @downloadURL  https://github.com/ibramsterdam/tornmanager/raw/main/userscript/recruiter.user.js
// @updateURL    https://github.com/ibramsterdam/tornmanager/raw/main/userscript/recruiter.user.js
...
(function () {
  ...
  class Overlay {
    ...
    renderFooter() {
      ...
      this.footer.appendChild(Dom.el("div", "rc-footer-version", `v${"0.3.5"}`));
    }
    openLegal(anchor) {
...
`;
  ...
  function boot() {
    ...
    new ChatOpener().init();
    console.log(`%cRecruiter %cv${"0.3.5"} is running.`, "font-weight: 700; color: #0070f3;", "color: inherit;");
  }
